...
if (empty($nameErr)) {
    # code...
    $stmt = $conn->prepare("INSERT INTO students_table (studentsname,email,phoneNumber,gender,age,studentImage) VALUES (?,?,?,?,?,?)");
...
if (isset($_GET['delete'])) {
    ...
    //delete sql 
    $deleteSql = "DELETE FROM students_table WHERE id='$id'";
...
//update 
 if (isset($_GET['edit'])) {
    ...
    $result = $conn->query("SELECT * FROM students_table WHERE id='$id'") or die($conn->error);
 ...
 if (isset($_POST['update'])) {
  ...
  if (empty($nameErr)) {
      # code...
    $updateSQL = "UPDATE students_table SET studentname='$name', email='$email', phoneNumber = '$phone' , gender = '$gender', age='$age' , studentImage= '$studentImage' WHERE id='$id' ";
